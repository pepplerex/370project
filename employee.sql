...
CREATE TABLE `employee` (
  ...
  `guarantor_address` varchar(50) NOT NULL,
  `guarantor_contact` varchar(50) NOT NULL,
...
INSERT INTO `employee` (`id`, `firstName`, `lastName`, `email`, `password`, `birthday`, `gender`, `contact`, `nid`, `address`, `dept`, `degree`, `pic`, `guarantor_name`, `guarantor_address`, `guarantor_contact`, `remarks`) VALUES
...
(112, 'Gtest', 'Glast', 'guarantor@test.com', '1234', '2000-01-01', 'Male', '123456789', 112001, 'Testy address test street', 'testlocation', 'test', 'images/1.jpg', 'Test gn', 'Test ga', 'Test gc', 'Awesome');
